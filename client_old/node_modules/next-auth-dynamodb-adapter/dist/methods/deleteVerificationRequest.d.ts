...
export declare const deleteVerificationRequest: ({ client, logger, tableOptions, }: {
...
}) => (email: string, verificationToken: string, _secret: string, _provider: SessionProvider) => Promise<void>;
