          ...
          <div className='lg:grid lg:grid-cols-2 lg:gap-8'>
            <div className='mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center'>
              <div className='lg:py-24'>
                ...
                >
                  <span className='px-3 py-0.5 text-white text-xs font-semibold leading-5 uppercase tracking-wide bg-teal-600 rounded-full'>
                    What's New
                  </span>
                  <span className='ml-4 text-sm'>Try the beta</span>
                ...
                <h1 className='mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl'>
                  ...
                  <span className='bg-clip-text text-transparent bg-teal-400 block'>
